...
urlpatterns = [
    ...
    path('teacher/buildquiz/<int:course_id>/<int:lesson_no>/<int:question_no>/',views.quizbuilder, name='teacher-buildquiz'),
    ...
    path('teacher/deletequestion/<int:course_id>/<int:lesson_no>/<int:question_no>/', views.teacher_deletequestion, name='teacher-deletequestion'),
    path('teacher/deletequiz/<int:course_id>/<int:lesson_no>/', views.teacher_deletequiz, name='teacher-deletequiz'),
    ...
    path('quiz/<int:course_id>/<int:lesson_no>/', views.quiz, name='quiz'),
